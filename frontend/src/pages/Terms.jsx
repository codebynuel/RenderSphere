    ...
    return (
        <main className="legal">
            ...
            >
                ...
                <p>RenderSphere provides cloud rendering services for Blender files. We process your .blend files, execute the render using the specified settings, and return the output.</p>
                ...
                <h2>3. Billing</h2>
                <p>Charges are calculated based on actual render execution time. RenderSphere deducts this amount from your starter balance. We are not responsible for renders that take longer than expected due to complex scene settings.</p>
