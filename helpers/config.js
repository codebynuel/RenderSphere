...
const config = {
  ...
  runpodGpuTypeId: process.env.RENDERSPHERE_RUNPOD_GPU_TYPE_ID || '',
  runpodPodTemplateId: process.env.RENDERSPHERE_RUNPOD_POD_TEMPLATE_ID || '',
  runpodPodId: process.env.RENDERSPHERE_RUNPOD_POD_ID || '',
  runpodPodStartTimeoutMs: parsePositiveIntegerEnv('RENDERSPHERE_RUNPOD_POD_START_TIMEOUT_MS', 120_000),
